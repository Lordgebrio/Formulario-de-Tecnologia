async function fillPdf() {
  ...
  const equipmentFields = ['teclado', 'cargador', 'guaya', 'base', 'pantalla', 'mouse', 'morral'];
  ...
  const softwareFields = ['windows10', 'windows11', 'office2016', 'office365', 'antivirus', 'winrar', 'acrobatReader', 'sapGui', 'teamViewer', 'adobeCloud', '7zip', 'impresoras', 'vpn', 'oneDrive'];
